...
- The old `/api/petkit/whep/...` endpoint is not used here. External consumers should use `/api/petkit/whep_mirror/{device_id}` with a Home Assistant long-lived access token in the query string.
